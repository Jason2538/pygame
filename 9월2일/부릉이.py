...
class Car():
    def __init__(self, x=0, y=0, dx=0, dy=0):
        ...
        car_images_path = resource_path('자습/assets\car')
        ...
        self.crash_image = pygame.image.load(os.path.join(crash_image_path))
...
class Game():
    def __init__(self):
        ...
        # 게임 리소스 로드
        menu_image_path = pygame.image.load(os.path.join(assets_path, "menu_car.png"))
        #self.image_intro = pygame.image.load(os.path.join(assets_path, "menu_image_path"))
        pygame.mixer.Sound(os.path.join(assets_path, "race.wav"))
