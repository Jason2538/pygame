...
class Spaceship(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load(os.path.join(assets_path, "spaceship.png"))
        self.explosion_image = pygame.image.load(os.path.join(assets_path, "explosion.png"))
        self.explosion_sound = pygame.mixer.Sound(os.path.join(assets_path, "explosion.wav"))
...
class Game():
    def __init__(self):
        self.menu_image = pygame.image.load(os.path.join(assets_path, "game_screen.png"))
        self.background_img = pygame.image.load(os.path.join(assets_path, "background.jpg"))
        self.font_70 = pygame.font.Font(os.path.join(assets_path, "NanumGothic.ttf"), 70)
        self.font_30 = pygame.font.Font(os.path.join(assets_path, "NanumGothic.ttf"), 30)
        self.warp_sound = pygame.mixer.Sound(os.path.join(assets_path, "warp.wav"))
        pygame.mixer.Sound(os.path.join(assets_path, "Inner_Sanctum.mp3"))
